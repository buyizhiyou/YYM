...
def get_dataset(name, path, train_transform, val_transform):
    if name == "cifar10":
        ...
        '''
        train_dataset = datasets.SVHN(root=path,
                                      split="train",
                                      download=False,
                                      transform=train_transform)

        val_dataset = datasets.SVHN(root=path,
                                    split="test",
                                    download=False,
                                    transform=val_transform)
        ...
        '''
        train_dataset = datasets.FashionMNIST(root=path,
                                              train=True,
                                              download=False,
                                              transform=train_transform)

        val_dataset = datasets.FashionMNIST(root=path,
                                            train=False,
                                            download=False,
                                            transform=val_transform)
