...
###########  Usage:
###########   ./evaluate.sh --gpu  0 --run 38 --batchsize 512 --evaltype gmm --ooddataset svhn --model resnet50  --perturbation fgsm --contrastive 0 --adv 0 --size 32"
...
#check ooddataset
ooddatasets=("mnist" "lsun" "svhn" "cifar100")
#check model
