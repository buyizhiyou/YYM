...
if __name__ == "__main__":
    ...
    if args.ambiguous:
        accuracy_file_name = (
            "logs/test_accs_" + save_name + '_' + args.al_type + save_ensemble_mi + "_dirty_mnist_" + str(args.subsample) + ".json"
        )
        ambiguous_file_name = (
            "logs/ambiguous_" + save_name + '_' + args.al_type + save_ensemble_mi + "_dirty_mnist_" + str(args.subsample) + ".json"
        )
        ambiguous_entropies_file_name = (
            "logs/ambiguous_entropies_" + save_name + '_' + args.al_type + save_ensemble_mi + "_dirty_mnist_" + str(args.subsample) + ".json"
        )
    else:
