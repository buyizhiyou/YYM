...
def training_args():
    ...
    parser = argparse.ArgumentParser(
        description="Args for training parameters",
    ...
    parser.add_argument(
        ...
        default=sn_coeff,
        dest="coeff",
        help="Coeff parameter for spectral normalisation",
    )
    parser.add_argument(
        "-mod",
        default=False,
...
def al_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        dest="tsn",
        help="whether to use spectral normalisation",
    )
    ...
    parser.add_argument(
        ...
        default=epochs,
        dest="epochs",
        help="Number of epochs to train after each acquisition",
    )
    parser.add_argument(
        "-b",
        type=int,
