...
def main():
    ...
    checkpoint = torch.load(
        "../saved_models/bayesian/resnet50/2023_11_17_20_53_02/resnet50_best_model_93.57.pth"
    )
    ...
    if dataname == "mnist" or dataname == "fashionmnist":
        val_transform.transforms.insert(
            2, transforms.Lambda(lambda x: x.repeat(3, 1, 1)))
